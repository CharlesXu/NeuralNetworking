...
class Network
{
	...
	// updateWeights() moves through each layer of the network 
	// and adds the changes calculated from the backpropagation algorithm
	// to the weights in the network
	
      	// Note that in order to use epochs and stochastic gradient descent, this method
	// must be edited so that the average dC_dw and average delta of many training results
	// is added.
